...
from .permissions import (
    can_manage_empresa_settings,
    is_profissional_user,
    user_module_access_map,
)
...
def empresa_context(request):
    ...
    module_access = user_module_access_map(user)
    ...
    return {
        ...
        "usuario_modulos": module_access,
        "usuario_pode_configurar_empresa": can_manage_empresa_settings(user, empresa_atual),
