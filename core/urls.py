...
urlpatterns = [
    ...
    path('cliente/empresa/<uuid:portal_token>/agendar/servico/<int:servico_id>/', views.cliente_agendar_servico, name='cliente_agendar_servico'),
    path('cliente/empresa/<uuid:portal_token>/agendar/profissional/<int:profissional_id>/', views.cliente_agendar_profissional, name='cliente_agendar_profissional'),
    ...
    path('cliente/empresa/<uuid:portal_token>/api/cliente/buscar/', views.cliente_lookup_api, name='cliente_lookup_api'),
